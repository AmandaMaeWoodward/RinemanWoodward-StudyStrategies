...
```{r}
StudyDat <- read_csv("StudyStrategyCodes.csv")
...
ggplot(PsGraph, aes(Strategies, fill=MC1_PriorStrategyUtility))+ geom_bar() + theme_classic()+ scale_fill_viridis(option="D", discrete=TRUE)
```
...
summary(glm2)
#Class years need to be modified
```
